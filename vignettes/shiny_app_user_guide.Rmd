...
Load the version of LandscapeRGolem provided to you by the Data Science team, or follow instructions in the [run app locally](running_app_locally.html) vignette to set up the app with new data.
