...
![](reference/figures/landscaper_hex.png)
...
[`ls_plot_variation_matrix()`](https://jpcompartir.github.io/LandscapeR/reference/ls_plot_variation_matrix.md)
function:
...
vignette](https://jpcompartir.github.io/LandscapeR/vignettes/running_app_locally.Rmd)
for tips on how to run the app.
